        ...
        <>
            <div className="navigasi">
                ...
                <Navbar bg="white" expand="lg">
                    ...
                    >
                        <Nav.Item>
                            <Nav.Link eventKey="link-0" href="#web" className='dtcNav-scroll'>Web Developer</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                            <Nav.Link eventKey="link-1" href="#frontend" className='dtcNav-scroll'>FrontEnd</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                            <Nav.Link eventKey="link-2" href="#backend" className='dtcNav-scroll'>Backend</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                            <Nav.Link eventKey="link-3" href="#mobile" className='dtcNav-scroll'>Mobile Developer</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                            <Nav.Link eventKey="link-4" href="#ui" className='dtcNav-scroll'>UI/UX</Nav.Link>
                        </Nav.Item>
                    </Nav>
                </Navbar>
            </div>
