      ...
      <Container className="course-modul">
          <Sidebar width ="300px">
            ...
            <ol className='list-modul'>
              <li> <a href='#'>introduction</a> <span className='float-end'><FaRegEdit/> <BsTrash  color='red'/></span></li>
              <li> <a href="#">HTML CSS</a> <span className='float-end'><FaRegEdit/> <BsTrash  color='red'/></span> </li>
              <li> <a href="#"> Bootstrap</a> <span className='float-end'><FaRegEdit/> <BsTrash  color='red'/></span></li>
              <li> <a href="#">Javascript</a> <span className='float-end'><FaRegEdit/> <BsTrash  color='red'/></span> </li>
              <li> <a href="#"> ES6 Modern Javascript</a> <span className='float-end'><FaRegEdit/> <BsTrash  color='red'/></span></li>
              <li> <a href="#">React Js</a> <span className='float-end'><FaRegEdit/> <BsTrash  color='red'/></span></li>
              <li> <a href="#">React Js Hooks</a> <span className='float-end'><FaRegEdit/> <BsTrash  color='red'/></span> </li>
              <li> <a href="#">React Native</a> <span className='float-end'><FaRegEdit/> <BsTrash  color='red'/></span></li>
            </ol>
            </Menu>
          </Sidebar>
